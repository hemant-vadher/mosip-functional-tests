...
public class DeviceTypeFilter extends AdminTestUtil implements ITest {
	...
	public void filterDeviceType(TestParameters objTestParameters, String testScenario, String testcaseName) throws AuthenticationTestException, AdminTestException {
		...
		String url=RunConfigUtil.objRunConfig.getAdminEndPointUrl() + RunConfigUtil.objRunConfig.getDeviceTypeFilterPath();
		logger.info("******Post request Json to EndPointUrl: " + url+ " *******");
		  postRequestAndGenerateOuputFileWithCookie(testCaseName.listFiles(), url,"request", "output-1-actual-response", 0, AUTHORIZATHION_COOKIENAME,
				  adminCookie); 
		  Map<String, List<OutputValidationDto>> ouputValid =
